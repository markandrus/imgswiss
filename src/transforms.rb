...
$transforms = {
  # Standard
    ...
    # Function Assignment
    # NOTE: We generate a tuple-list by zipping the names of our vars with
    # the ordered values generated by our function call
    '<='            => lambda { |s, a|
                                    hash = { }
                                    ps = v(s,a[0]).zip(v(s,a[1]).values)
                                    ps.each { |k, v| hash[k] = v }
                                    hash },
  # RMagick
    # edge $$ radius 
